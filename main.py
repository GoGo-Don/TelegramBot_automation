...
class Application:
    ...
    async def _initialize_state_manager(self) -> None:
        ...
        try:
            ...
            self.logger.info("State manager instance created")
    ...
    async def run(self) -> None:
        ...
        # Create decorator instance from self.perf_logger
        decorator = self.perf_logger.log_function_performance("application_startup")
        ...
        # Call the inner decorated async function
        await _run_inner()
